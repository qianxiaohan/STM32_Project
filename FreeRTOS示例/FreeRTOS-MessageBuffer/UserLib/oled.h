...
#define MAX_COLUMN 128   //OLED列最大值
...
void OLED_ClearArea(uint16_t X, uint16_t Y, uint16_t W, uint16_t H);
void OLED_ClearText(uint16_t page, uint16_t col, uint16_t num);
void OLED_DrawImage(uint16_t X, uint16_t Y, uint16_t W, uint16_t H, const uint8_t *Image);
