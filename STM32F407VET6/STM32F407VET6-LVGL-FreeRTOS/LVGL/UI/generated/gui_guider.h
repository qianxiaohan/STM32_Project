...
typedef struct
{
	...
	lv_obj_t *screen;
	bool screen_del;
	lv_obj_t *screen_sw_LED2;
	lv_obj_t *screen_label_LED1;
	lv_obj_t *screen_sw_LED1;
	lv_obj_t *screen_label_LED2;
	lv_obj_t *screen_img_1;
	lv_obj_t *screen_img_2;
	lv_obj_t *screen_img_3;
	lv_obj_t *screen_label_IP;
	lv_obj_t *screen_label_humi;
	lv_obj_t *screen_label_temp;
	lv_obj_t *screen_label_date;
	lv_obj_t *screen_led_1;
	lv_obj_t *screen_label_status;
}lv_ui;
...
LV_IMG_DECLARE(_IP_alpha_50x50);
